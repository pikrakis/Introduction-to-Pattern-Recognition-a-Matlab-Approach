...
[piTrained_1, ATrained_1, BTrained_1, SumRecProbs_1]=...
    MultSeqTrainDoHMMBWsc(pi_init_1, A_init_1, B_init_1,NumericData(1:70), maxEpoch);
...
[piTrained_2, ATrained_2, BTrained_2,SumRecProbs_2]=...
    MultSeqTrainDoHMMBWsc(pi_init_2, A_init_2, B_init_2,NumericData(1:70), maxEpoch);
